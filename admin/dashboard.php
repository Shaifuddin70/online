                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="card p-30">
                                        <div class="media">
                                            <div class="media-left meida media-middle">
                                                <span><i class="fa-solid fa-bangladeshi-taka-sign f-s-40" aria-hidden="true"></i></span>
                                            </div>
                                            <div class="media-body media-text-right">
                                                <h2><?php
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="card p-30">
                                        <div class="media">
                                            <div class="media-left meida media-middle">
                                                <span><i class="fa-solid fa-flag f-s-40"></i></span>
                                            </div>
                                            <div class="media-body media-text-right f-s-30 ">
                                                <p class="p-3">Sales Report</p>
                                            </div>
                                        </div>
                                    </div>
                                    </a>
